...
% Straight forward runs of the Gillespie Lattice Model. Uses the
% First-Reaction method of the Gillespie Algorithm to model the
% interactions between RAD51 and a DNA lattice. Number of times a set of
% parameters is run is determined by "Iterations". Generates growth
% profiles (saturation) of the DNA lattic over time.
...
Iterations = 1;    %number of iterations at each ratio value
